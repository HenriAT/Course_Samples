...
public class HetuTarkistus {
     ...
     */  
     public String tarkista(String hetu) {
         ...
         if (!SisaltaaTarkistaja.onkoVain(pvm, SisaltaaTarkistaja.getNumerot())) return "Alkuosassa saa olla vain numeroita"; 
         ...
         if ( !SisaltaaTarkistaja.onkoVain(erotin,"+-A")) return "Väärä erotinmerkki";
         String yksilo = hetu.substring(7,10);
         if (!SisaltaaTarkistaja.onkoVain(yksilo, SisaltaaTarkistaja.getNumerot())) return "Yksilöosassa kirjaimia";
